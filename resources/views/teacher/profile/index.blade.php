                        ...
                        <div class="position-relative">
                            ...
                            <div class="profile-img-container d-flex align-items-center">
                                ...
                                <div class="profile-title ms-3">
                                    <h2 class="text-white">{{ $user->teacher->name }}</h2>
                                    <p class="text-white">{{ $user->teacher->nip }}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="mt-2">
                                    ...
                                    <p class="card-text">{{ $user->teacher->nip }}</p>
                                </div>
                                <div class="mt-2">
    ...
    <div class="modal fade text-start" id="update" tabindex="-1" aria-labelledby="myModalLabel33" aria-hidden="true">
        <div class="modal-dialog sidebar-sm">
            <form class="add-new-record modal-content pt-0" method="POST"
                action="{{ route('teacher.profil.edit', $user->email) }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="modal-body flex-grow-1">
                    ...
                    <div class="mb-1">
                        ...
                        <input class="form-control" type="text" id="nip" name="nip" value=" {{ $user->teacher->nip }}">
                    </div>
                    <div class="mb-1">
