                ...
                <tr>
                    <td>
                        <p style="text-align: justify">
                            <b>Nama orang tua / wali</b> tertulis <b>{{ $request->nama_wali_salahnw }}</b>, sesuai
                            dengan Kutipan Akta Kelahiran yang dikeluarkan oleh Kepala Dinas Kependudukan Dan
                            Pencatatan Sipil {{ $request->dispendukcapilnw }}, nomor :
                            {{ $request->nomor_aktanw }},
                            tanggal {{ $tanggal_aktanw }} yang benar
                            adalah <b>{{ $request->nama_wali_benarnw }}</b>
                        </p>
                    </td>
                </tr>
            </tbody>
