                ...
                <tr>
                    <td>
                        <p style="text-align: justify">
                            <b>Tanggal lahir siswa</b> tertulis <b>{{ $tanggal_lahir_salahtgl }}</b>, sesuai
                            dengan
                            Kutipan
                            Akta Kelahiran yang dikeluarkan oleh Kepala Dinas Kependudukan Dan
                            Pencatatan Sipil {{ $request->dispendukcapiltgl }}, nomor :
                            {{ $request->nomor_aktatgl }},
                            tanggal {{ $tanggal_aktatgl }} yang benar
                            adalah <b>{{ $tanggal_lahir_benartgl }}</b>
                        </p>
                    </td>
                </tr>
            </tbody>
