                ...
                <tr>
                    <td>
                        <p style="text-align: justify">
                            <b>Tempat lahir siswa</b> tertulis <b>{{ $request->tempat_lahir_salahtl }}</b>, sesuai
                            dengan
                            Kutipan
                            Akta Kelahiran yang dikeluarkan oleh Kepala Dinas Kependudukan Dan
                            Pencatatan Sipil {{ $request->dispendukcapiltl }}, nomor :
                            {{ $request->nomor_aktatl }},
                            tanggal {{ $tanggal_aktatl }} yang benar
                            adalah <b>{{ $request->tempat_lahir_benartl }}</b>
                        </p>
                    </td>
                </tr>
            </tbody>
